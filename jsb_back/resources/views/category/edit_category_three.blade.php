...
<div class="bg-white p-3">
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">編輯子分類</li>
                </ol>
            </nav>
        </div>
    </div>
    <hr/>
    <!-------------------------------------------------------------->
    <form action="{{route('updateKidCategory')}}" method="POST" class="p-2">
    {{ csrf_field() }} 
        <div class="my-4 row   align-items-center g-0">
            ...
            <div class="col-md-10 col-12">
                <div class="col-md-10 col-12">
                    ...
                    <input class="form-control" type="hidden" name="cateKidId" placeholder="主分類名稱" readonly="readonly" value="{{$cateKidId}}">
                    <input class="form-control" type="text" placeholder="主分類名稱" readonly="readonly" value="{{$cateKid[0]->cateMainName}}">
                </div>
            </div>
        </div>
        {{-- <div class="my-4 row   align-items-center g-0">
            ...
            <div class="col-md-10 col-12">
                <div class="col-md-10 col-12">
                    <input class="form-control" type="text" placeholder="次分類名稱" readonly="readonly" value="{{$cateKid[0]->cateMidName}}">
                </div>
            </div>
        </div> --}}
        <div class="my-4 row  align-items-center g-0">
            ...
            <div class="col-md-10 col-12">
                <input class="form-control" name="cateKidName" type="text" placeholder="分類名稱" required value="{{$cateKid[0]->cateKidName}}">
            </div>
        </div>
        <div class="my-4 row   align-items-center g-0">
            <h3 class="col-xxl-1 col-md-2 col-12 fs-6 text-center text-start m-md-0 mb-1">啟用</h3>
            <label class="switch">
                    @if($cateKid[0]->enable == 1)
        ...
        <div class="my-4 row   align-items-center g-0">
            ...
            <div class="col-md-10 col-12">
                <select class="form-select" aria-label="Default select example" name="sort">
                    <?for($i=1;$i<=50;$i++){?>
                        <option value="<?=$i?>" <?if($cateKid[0]->sort==$i){?>selected<?}?>><?=$i?></option>
                    <?}?>
                </select>
            </div>
        </div>
