...
<div class="bg-white p-3">
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    {{-- <li class="breadcrumb-item"><a href="{{route('ProductsCatergoryThirdDetail',['cateMainId'=>$cateMainId])}}">子分類管理</a></li> --}}
                    <li class="breadcrumb-item active" aria-current="page">新增子分類</li>
                </ol>
            </nav>
        </div>
    </div>
    <hr/>
    <!-------------------------------------------------------------->
    <form action="{{route('CateKidInsert')}}" method="POST" class="p-2">
    {{ csrf_field() }}
    <input class="form-control" type="hidden" name="cateMainId" placeholder="主分類名稱" readonly="readonly" value="{{$cateMainId}}">
        ...
        {{-- <div class="my-4 row   align-items-center g-0">
            <h3 class="col-xxl-1 col-md-2 col-12 fs-6 text-center text-start m-md-0 mb-1">次分類</h3>
            <div class="col-md-10 col-12">
                <div class="col-md-10 col-12">
                    <input class="form-control" type="hidden" name="cateMidId" placeholder="次分類名稱" readonly="readonly" value="{{$cateMidId}}">
                    <input class="form-control" type="text" placeholder="主分類名稱" readonly="readonly" value="{{$cateMid[0]->cateMidName}}">
                </div>
            </div>
        </div> --}}
        <div class="my-4 row  align-items-center g-0">
            <h3 class="col-xxl-1 col-md-2 col-12 fs-6 text-center text-start m-md-0 mb-1">標籤名稱</h3>
            <div class="col-md-10 col-12">
                <input class="form-control" name="cateKidName" type="text" placeholder="輸入標籤名稱" required>
            </div>
        </div>
        <div class="my-4 row   align-items-center g-0">
        ...
        <div class="text-end">
            {{-- <a type="submit" href="{{route('ProductsCatergoryThirdDetail',['cateMainId'=>$cateMainId])}}" class="btn btn-secondary">取消</a> --}}
