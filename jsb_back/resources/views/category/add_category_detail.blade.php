...
<div class="bg-white p-3">
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">新增次分類</li>
                </ol>
            </nav>
        </div>
    </div>
    <hr/>
    <!-------------------------------------------------------------->    
    <form action="{{route('CateMidInsert')}}" class="p-2" method="POST">
    {{ csrf_field() }}
        <div class="my-4 row   align-items-center g-0">
            ...
            <div class="col-md-10 col-12">
                ...
                <input class="form-control" type="text" placeholder="主分類名稱" readonly="readonly" value="{{$cateMainName[0]->cateMainName}}">
            </div>
        </div>
        <div class="my-4 row  align-items-center g-0">
            <h3 class="col-xxl-1 col-md-2 col-12 fs-6 text-center text-start m-md-0 mb-1">次分類名稱</h3>
            <div class="col-md-10 col-12">
                <input class="form-control" type="text" name="cateMidName" placeholder="輸入次分類名稱" required>
            </div>
        </div>
        <div class="my-4 row   align-items-center g-0">
