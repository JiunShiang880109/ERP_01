        ...
        <div class="content-wrap mt-3">
            <div class="main">
                <div class="card alert ">
                        <div class="card-body">
                            <form action="{{route('employeeCreate')}}" enctype="multipart/form-data"  method="POST" class="row g-3">
                                 @csrf
                                 <div class="card-title d-flex align-items-center">
                                    <div><i class="bx bxs-edit me-1 font-22 text-primary"></i>
                                    </div>
                                    <h5 class="mb-0 text-primary">新增員工</h5>
                                </div>
                                <hr>
                                {{--  --}}
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <img id="preview" src="{{asset('assets/images/avatars/avatar-0.png')}}" class="rounded-circle p-1 border" width="95" height="95" alt="...">
                                        </div>
                                        <div class="col-lg-8">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="employeeId" class="form-control" value="{{$employeeId}}" readonly>
                                </div>
                                <div class="col-md-4">
                                ...
                                {{-- <div class="col-md-3">
                                    <label for="inputEmail" class="form-label">店別</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="commAddr" class="form-control" value="">
                                </div>
                                <div class="col-md-6">
                                    <label for="inputLastName" class="form-label">戶籍地址</label>
                                    <input type="text" name="resiAddr" class="form-control" value="">
                                </div>
                                {{--  --}}
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="urgentPsn" class="form-control" value="">
                                </div>
                                <div class="col-md-4">
                                    <label for="inputLastName" class="form-label">連絡人電話</label>
                                    <input type="text" name="urgentTel" class="form-control" value="">
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" name="entryDate" class="form-control" value="{{date('Y-m-d')}}">
                                </div>
                                {{--  --}}
                                <div class="col-12">
