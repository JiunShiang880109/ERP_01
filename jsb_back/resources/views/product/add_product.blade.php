        ...
        <div class="content-wrap mt-3">
            <div class="main">
                <div class="card alert ">
                        <div class="card-body">
                            <form action="{{route('product_create')}}" enctype="multipart/form-data"  method="POST" class="row g-3">
                                 @csrf
                                 <div class="card-title d-flex align-items-center">
                                    <div><i class="bx bxs-edit me-1 font-22 text-primary"></i>
                                    </div>
                                    <h5 class="mb-0 text-primary">新增商品</h5>
                                </div>
                                <hr>
                                {{--  --}}
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <img id="preview" src="{{asset('assets/images/avatars/avatar-0.png')}}" class="rounded p-1 border" width="160" height="160">
                                        </div>
                                        <div class="col-lg-8">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" name="categoryId" id="categoryId">
                                        <option value='-1' selected>選擇類別</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="tel" name="price" class="form-control" value="" required>
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="number" name="feedback_point" class="form-control" value="" >
                                </div>
                                 {{--  --}}
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="multiple-select" id="customCateId" name="customCateId[]" data-placeholder="選擇餐點口誤" multiple="multiple">
      ...
      var cate1Id =  parseInt($(this).val());
        $.ajax({
            ...
            success:function(data){             
                //console.log(data);
               var NumOfData = data['cate2'].length;
               $('#customCateId').empty();
                var html = '';
               // html +="<option value='-1' selected>選擇次類別</option>";
               for (var i = 0; i < NumOfData; i++) {
                    html +="<option value="+data['cate2'][i]['id']+">"+data['cate2'][i]['customCateTitle']+"</option>";       
               }     
               $("#customCateId").append(html);
...
function addRow(){
    ...
    <tr>
        ...
        <td>
            <input type="number" name="usageQty[]" step="1" class="form-control" placeholder="數量" required>
        </td>
    ...
    document.querySelector("#recipeTable tbody").insertAdjacentHTML('beforeend', row);
}
